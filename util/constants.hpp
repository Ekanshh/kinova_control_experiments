...
const std::vector<std::string> ABAG_CONFIG_NAMES{ALPHA, BIAS_THRES, BIAS_STEP, GAIN_THRES,
                                                 GAIN_STEP};
...
const std::string URDF_PATH = "description/urdf/kinova-gen3_urdf_V12.urdf";
 ...
 * However, in the urdf model, joint between Bracelet_Link and EndEffector_Link is fixed (not
 * counted in KDL) Vereshchagin does not support un-equal number of joints and segments Arm
 * length: 1.1873m
 */
